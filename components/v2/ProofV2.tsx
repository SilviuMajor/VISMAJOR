      ...
      <Container>
        ...
        <Reveal>
          <div className="flex items-center justify-between gap-4">
            <span className="caps-loose text-[11px] font-semibold text-ink-0">
            ...
            <span className="flex items-center gap-2">
              ...
              <span className="caps text-[10px] font-semibold text-ink-0/70">
                Early-bird open
              </span>
            </span>
          </div>
        ...
        <Reveal delay={0.05}>
          ...
          >
            ...
            <p className="max-w-md pb-1 text-[16.5px] leading-[1.6] text-ink-0 lg:justify-self-end">
              ...
              <span className="font-mono text-ink-0/45 line-through">£32</span> at launch
          ...
          <div className="mt-10">
            <div className="flex items-end justify-between">
              ...
              <span className="flex items-baseline gap-2">
                ...
                <span className="caps text-[10.5px] font-semibold text-ink-0">reserved</span>
              </span>
            </div>
            <div className="mt-4">
              <AllocationMeter />
                ...
                <div className="marquee-group" key={group} aria-hidden={group === 1}>
                  {marqueeQuotes.map((qt, i) => (
                    ...
                    >
                      ...
                      <figcaption className="caps text-[10.5px] font-semibold text-ink-0/70">
                        {qt.a}
                      </figcaption>
                    </figure>
                  ))}
        ...
        <Reveal delay={0.05}>
          <ul className="mt-8 flex flex-wrap items-center gap-x-7 gap-y-3">
            {TRUST.map((t) => (
              <li
                key={t}
                className="caps inline-flex items-center gap-2 text-[10px] font-semibold text-ink-0/70"
              >
